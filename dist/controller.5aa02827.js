...
exports.state = exports.fetchProducts = exports.createCartObject = void 0;
...
exports.navigateToProductPage = exports.navigateToCheckout = exports.deBounceFunc = exports.calcCartTotal = void 0;
//////////////////////////////////////////////////////
//DOM
// header
...
var findItemfromFilter = function findItemfromFilter(filterName, genre) {
  if (_model.state.filter.find(function (e) {
    return e[genre] === filterName;
  })) {
    var temp = _model.state.filter.filter(function (e) {
      return e[genre] !== filterName;
    });

    _model.state.filter = temp;
  } else {
    _model.state.filter.push(_defineProperty({}, genre, filterName));
  }
}; // ///////////////////
//filter handler
...
var filterHandler = function filterHandler(e) {
  ...
  if (filterName === 'Polo' || filterName === 'Hoodie' || filterName === 'Basic') {
    findItemfromFilter(filterName, "type", _model.state);
  }
  ...
  var curFilter = _model.state.filter[_model.state.filter.length - 1];
  var prevFilter = _model.state.filter.length > 1 ? _model.state.filter[_model.state.filter.length - 2] : null;

  var filterCriteria = _model.state.filter.map(function (e) {
    if (Object.keys(e).includes('color') || Object.keys(e).includes('type') || Object.keys(e).includes('price') || Object.keys(e).includes('gender')) {
      return Object.values(e)[0];
    }
  });

  var tempFilterdData = [];
  var filterToApply = _model.state.searchFilterData.length > 0 ? _model.state.searchFilterData : prevFilter && _model.state.filterData.length > 0 && Object.keys(curFilter)[0] !== Object.keys(prevFilter)[0] ? _model.state.filterData : _model.state.data; //if the applied filters are of the same genre
  ...
  if (prevFilter && Object.keys(curFilter)[0] === Object.keys(prevFilter)[0]) {
    ...
    if (curFilter) {
      for (var _j = 0; _j < filterToApply.length; _j++) {
        if (Object.values(filterToApply[_j]).includes(Object.values(curFilter)[0])) {
          tempFilterdData.push(filterToApply[_j]);
        }
      }
    }
  }
  ...
  _model.state.filterData = tempFilterdData; //reset to original state if there are no filters

  if (_model.state.filterData.length === 0) {
    btnView.render();
    return;
  }

  filterView.render(_model.state.filterData);
...
},{"../view/productsView":"scripts/view/productsView.js","../view/btnView":"scripts/view/btnView.js","../model/model":"scripts/model/model.js","../view/cartView":"scripts/view/cartView.js","../view/filterView":"scripts/view/filterView.js","../view/precheckoutCart":"scripts/view/precheckoutCart.js","../view/navView":"scripts/view/navView.js","../view/searchView":"scripts/view/searchView.js","../helper":"scripts/helper.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/controller/controller.js"], null)
